#
#  Be sure to run `pod spec lint XJLibrary.podspec' to ensure this is a
...
这是我制作的一个cocoaPods库，用于练习，详细的创造过程参考简书http://www.jianshu.com/p/82d3f83241f3
  ...
  # Or just: s.author    = "肖金兴"
  # s.authors            = { "肖金兴" => "xiao-jinxing@sohu.com" }
  # s.social_media_url   = "http://twitter.com/肖金兴"
  ...
  s.source_files  = "CocoaPodsLibrary", "CocoaPodsLibrary/**/*.{h,m}"
